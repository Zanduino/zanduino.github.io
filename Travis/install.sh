#!/usr/bin/env bash
####################################################################################################################################
## Bash Script for building projects using Travis-CI.                                                                             ##
## The script was copied from the ADAFRUIT original version on 2020-06-10 and modified for use in the Zanduino project            ##
##                                                                                                                                ##
## Date       Developer                     Comments                                                                              ##
## ========== ============================= ===================================================================================== ##
## 2020-06-10 https://github.com/SV-Zanshin Cloned from original script written by adafruit                                       ##
##                                                                                                                                ##
####################################################################################################################################
GRAY='\033[1;30m'
RED='\033[0;31m'
...
echo "${GREEN}Travis-CI${WHITE} build on LINUX, script version ${LGREEN}1.0.0${WHITE}"
